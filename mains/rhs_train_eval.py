import nns.models.rhsRNN as rhsRNN
from nns.run_network import train_rhs_network as trainer
...
if __name__ == '__main__':
    ...
    conll(dispatch,dataset='pos')
    conll(dispatch,dataset='chunk')
    conll(dispatch,dataset='ccg')
    dispatch.main_task.split(0.75)
    dispatch['pos'].split(0.75)
    ...
    model = rhsRNN.network(data,targets,istrain,embeddings,conf)
